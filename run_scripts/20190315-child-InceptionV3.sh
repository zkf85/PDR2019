...
#===============================================================================
category_name="apple"
for category_name in "apple" "cherry" "citrus" "corn" "grape" "peach" "pepper" "potato" "strawberry" "tomato"
do
    date=`date +%Y%m%d`
    # Hyper-parameters
    epochs=100
    ...
    # Paths
    data_base_dir="/home/kefeng/data_pool/plant_disease_dataset/dataset_for_10x_classifiers"
    ...
    plots_dir="$script_dir/03-disease-classifiers-10x/plots"
